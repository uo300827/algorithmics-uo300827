...
public class Vector1 {
	...
	/**
	 * This method calculates the number of matches of the input vectors (they are
	 * of the same dimension). We define a match as the fact that on the same
	 * position there is the same value in both vectors. In this case it is solved
	 * "with the happy idea" of two nested loops
	 * 
	 * @param a a Vector
